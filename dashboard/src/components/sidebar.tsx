...
const iconMap: Record<string, JSX.Element> = {
  ...
  briefcase: <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.8} d="M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4"/></svg>,
  search: <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.8} d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z"/></svg>,
  ...
  sparkles: <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.8} d="M5 3v4M3 5h4M6 17v4m-2-2h4m5-16l2.286 6.857L21 12l-5.714 2.143L13 21l-2.286-6.857L5 12l5.714-2.143L13 3z"/></svg>,
...
export function Sidebar() {
  ...
  return (
    <aside className="hidden lg:flex lg:flex-col lg:w-[260px] bg-gradient-to-b from-brand-950 to-brand-900 text-white">
      {/* Logo */}
      ...
      <nav className="flex-1 px-3 py-6 space-y-1">
        {navigation.map((item) => {
          ...
          return (
            ...
            >
              <span className={cn("transition-colors", isActive ? "text-brand-300" : "text-white/50")}>
                {iconMap[item.icon]}
              </span>
              {item.name}
