...
export function ThemeToggle() {
  ...
  useEffect(() => {
    const saved = localStorage.getItem("greevo_theme");
  ...
  return (
    <button onClick={toggle} className="p-2 rounded-xl hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors" title="Toggle theme">
      {dark ? (
